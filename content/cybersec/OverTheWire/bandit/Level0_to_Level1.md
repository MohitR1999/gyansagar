---
title: Level 0 to Level 1
---
Now while being logged in as the user `bandit0`, you need to find the password of user `bandit1` in order to complete this level.
...
- This will show you the password of the user `bandit1`. Note that down and proceed forward to the next level.
